...
** Unicode-mode
   To facilitate writing emoji/unicode, I'm adding a minor mode for
   the most used characters.
#+BEGIN_SRC emacs-lisp
(defvar unicode-mode-keymap (make-keymap) "unicode-mode keymap")
...
(define-minor-mode unicode-mode "Unicode art mode" :lighter " Unicode" :global t :keymap unicode-mode-keymap)
#+END_SRC
