...
From time to time we need to deal with really ugly "JSON", eg from
Outlook email. To clean this up, we have this baby.
...
#+END_SRC
   ...
   When using =projectile-switch-project= I'll use dired rather than
   find-file.
